    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      {
        ...
        ? <label htmlFor='image'>
          <div className='inline-block relative cursor-pointer'> 
            ...
            <img className='w-10 absolute bottom-12 right-12' src={image ? URL.createObjectURL(image): assets.upload_icon } alt="" />
          </div>
        ...
        <div>
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutrl-700'>
